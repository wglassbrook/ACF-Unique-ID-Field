...
// Function to generate a short (default 8 char) ID that always begins with a letter
function gen_uid($l=8){
	...
	$uid .= substr(str_shuffle("0123456789abcdefghijklmnopqrstuvwxyz"), 0, $l-1);
	return $uid;
}
	...
	class acf_field_unique_id extends acf_field {
		...
		*/
		...
		function __construct() {
			...
			*/
			$this->label = __('Unique ID', 'acf_unique_id');
		...
		*/
		function update_value( $value, $post_id, $field ) {
			...
			// Sanitize any input in this field
